...
exports.getPlans = (req, res) => {
    res.json({
        ...
        monthly: { planId: PLAN_CONFIG.monthly.planId, price: PLAN_CONFIG.monthly.price, period: "month" },
        yearly: { planId: PLAN_CONFIG.yearly.planId, price: PLAN_CONFIG.yearly.price, period: "year" },
    });
};
